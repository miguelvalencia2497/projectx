...
if User.count == 0
    ...
    user      = User.new(role: 'user', email: 'user@projectx.com', first_name: 'Diana', last_name: 'Prince', password: 'P@$$W0rd', password_confirmation: "P@$$W0rd", created_at: DateTime.now, updated_at: DateTime.now)
    user.save!
